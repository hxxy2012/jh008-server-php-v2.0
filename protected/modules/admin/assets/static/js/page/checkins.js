define(function(require, exports, module){
	...
	$(function(){
		...
		function enterDetailPage(actId) {
			var dialog = wait();
	        server.getCheckinUsers({actId: actId, page: 1, size: static.checinsUsersNum}, function(resp){
	        	/*var resp = {
	        		code: 0,
					msg: 'ssdf',
					body: {
	    ...
	    var page = {
	    	...
	    	bindEvents: function() {
				$('#search').click(function(){
					...
					var dialog = wait();
					server.getCheckinActs({keyWords: keyWord, page:1, size: static.checkinsPerNum}, function(resp){
						/*var resp = {
