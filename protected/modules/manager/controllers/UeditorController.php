...
class UeditorController extends ManagerController
{
     ...
     * Action List
     */
    public function actionMuliti()
    {
        $config_json = '/* 前后端通信相关的配置,注释只允许使用多行方式 */
        {
            /* 上传图片配置项 */
            ...
            "fileMaxSize": 1024000000, /* 上传大小限制，单位B，默认50MB 51200000B */
            "fileAllowFiles": [
        ...
        $CONFIG['imageUrlPrefix'] = Yii::app()->params['imgUpload']['downUrlPre'] . '/';
        $action = $_GET['action'];
