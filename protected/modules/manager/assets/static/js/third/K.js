...
(function(K){
	...
	Table.prototype = {
		...
		setWhichRow: function(which, rowIndex) {
			...
			//datas.splice(rowIndex, 1, which.data);
			this.refresh(datas);
		},
		getModel: function() {
			return this.datas;
