...
/**
 * This is the model class for table "manager_tag_remark".
 *
 * The followings are the available columns in table 'manager_tag_remark':
 * @property string $id
 ...
 * @property ActTag $tag
 */
class ManagerTagRemark extends ManagerModel
{
	/**
	 ...
	 * @return ManagerTagRemark the static model class
	 */
