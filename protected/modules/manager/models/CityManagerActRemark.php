...
/**
 * This is the model class for table "city_manager_act_remark".
 *
 * The followings are the available columns in table 'city_manager_act_remark':
 * @property string $id
 ...
 * @property CityManager $act
 */
class CityManagerActRemark extends ManagerModel
{
	/**
	...
	{
		return 'city_manager_act_remark';
	}
	...
	public function relations()
	{
		...
		return array(
			...
			'act' => array(self::BELONGS_TO, 'CityManager', 'act_id'),
		);
	}
	 ...
	 * @return CityManagerActRemark the static model class
	 */
    ...
    {
        if (empty($model)) {
            $model = new CityManagerActRemark();
        }
        $model->m_id = $mid;
        $model->act_id = $actId;
        $model->remark = $remark;
