...
/**
 * This is the model class for table "city_manager_tag_remark".
 *
 * The followings are the available columns in table 'city_manager_tag_remark':
 * @property string $id
 ...
 * @property ActTag $tag
 */
class CityManagerTagRemark extends ManagerModel
{
	/**
	...
	{
		return 'city_manager_tag_remark';
	}
	 ...
	 * @return CityManagerTagRemark the static model class
	 */
    ...
    {
        if (empty($model)) {
            $model = new CityManagerTagRemark();
        }
        $model->m_id = $mid;
        $model->tag_id = $tagId;
        $model->remark = $remark;
