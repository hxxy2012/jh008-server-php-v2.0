...
/**
 * This is the model class for table "video_up_manager_map".
 *
 * The followings are the available columns in table 'video_up_manager_map':
 * @property string $id
 ...
 */
class VideoUpManagerMap extends ManagerModel
{
	/**
	 ...
	 * @return VideoUpManagerMap the static model class
	 */
