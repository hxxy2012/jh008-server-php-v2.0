...
/**
 * This is the model class for table "manager_user_remark".
 *
 * The followings are the available columns in table 'manager_user_remark':
 * @property string $id
 ...
 * @property UserInfo $u
 */
class ManagerUserRemark extends ManagerModel
{
	/**
	 ...
	 * @return ManagerUserRemark the static model class
	 */
