...
/**
 * This is the model class for table "city_manager_user_tag_remark".
 *
 * The followings are the available columns in table 'city_manager_user_tag_remark':
 * @property string $id
 ...
 */
class CityManagerUserTagRemark extends ManagerInfo
{
	/**
	...
	{
		return 'city_manager_user_tag_remark';
	}
	 ...
	 * @return CityManagerUserTagRemark the static model class
	 */
    ...
    {
        if (empty($model)) {
            $model = new CityManagerUserTagRemark();
        }
        $model->m_id = $mid;
        $model->tag_id = $tagId;
        $model->remark = $remark;
