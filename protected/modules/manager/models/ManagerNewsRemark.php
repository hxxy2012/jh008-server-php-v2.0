...
/**
 * This is the model class for table "manager_news_remark".
 *
 * The followings are the available columns in table 'manager_news_remark':
 * @property string $id
 ...
 */
class ManagerNewsRemark extends ManagerModel
{
	/**
	 ...
	 * @return ManagerNewsRemark the static model class
	 */
