...
/**
 * This is the model class for table "img_up_manager_map".
 *
 * The followings are the available columns in table 'img_up_manager_map':
 * @property string $id
 ...
 */
class ImgUpManagerMap extends ManagerModel
{
	/**
