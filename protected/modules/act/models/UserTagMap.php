...
/**
 * This is the model class for table "user_tag_map".
 *
 * The followings are the available columns in table 'user_tag_map':
 * @property string $id
 ...
 */
class UserTagMap extends ActModel
{
	/**
	 ...
	 * @return UserTagMap the static model class
	 */
