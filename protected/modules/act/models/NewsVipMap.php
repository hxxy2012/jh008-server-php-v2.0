...
/**
 * This is the model class for table "news_vip_map".
 *
 * The followings are the available columns in table 'news_vip_map':
 * @property string $id
 ...
 * @property UserInfo $u
 */
class NewsVipMap extends ActModel
{
	/**
	...
	public function rules()
	{
		...
		return array(
			...
			array('id, news_id, u_id, status, create_time', 'safe', 'on'=>'search'),
		);
	}
	 ...
	 * @return NewsVipMap the static model class
	 */
     ...
     */
    public function vips($cityId, $newsId, $page, $size, $currUid)
    {
        $cr = new CDbCriteria();
