 ...
 * @property UserMessageMap[] $userMessageMaps
 */
class UserMessage extends ActModel
{
	/**
	...
	public function relations()
	{
		...
		return array(
			//'userContacts' => array(self::HAS_MANY, 'UserContact', 'last_msg_id'),
			//'userMessageMaps' => array(self::HAS_MANY, 'UserMessageMap', 'msg_id'),
		);
	}
     ...
     */
    public function add($content, $model = NULL)
    {
        if (empty($model)) {
