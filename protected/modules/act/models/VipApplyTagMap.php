...
/**
 * This is the model class for table "vip_apply_tag_map".
 *
 * The followings are the available columns in table 'vip_apply_tag_map':
 * @property string $id
 ...
 */
class VipApplyTagMap extends ActModel
{
	/**
	...
	public function rules()
	{
		...
		return array(
			array('apply_id, tag_id, create_time', 'required'),
	 ...
	 * @return VipApplyTagMap the static model class
	 */
