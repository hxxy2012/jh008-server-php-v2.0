...
/**
 * This is the model class for table "act_place_img".
 *
 * The followings are the available columns in table 'act_place_img':
 * @property string $id
 ...
 */
class ActPlaceImg extends ActModel
{
	/**
	...
	public function rules()
	{
		...
		return array(
			...
			array('id, act_id, subject, img_id, status, create_time, modify_time', 'safe', 'on'=>'search'),
		);
	}
	 ...
	 * @return ActPlaceImg the static model class
	 */
     ...
     */
    public function placeImgs($actId, $page, $size) 
    {
        $cr = new CDbCriteria();
        ...
        foreach ($rst as $v) {
            ...
            $model['img_url'] = $img['img_url'];
            array_push($imgs, $model);
        }
