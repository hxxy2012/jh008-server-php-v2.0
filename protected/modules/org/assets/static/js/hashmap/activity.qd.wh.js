...
define(function (require, exports, module){ 
    ...
    function addCheckIn(checkin,add){
        if(checkin == null){
            ...
            //生成二维码
            makeQrCode($(".c3_4_1_4_2",checkin_ele).get(0),checkin.id,{width:995,height:995});
            addCheckIn.i++;
    ...
    function qr_url_create(id){
        return '/org/Checkin/qr?id='+encodeURIComponent(id);
    }
    /**
     * 二维码生成的方法
     */
    function makeQrCode(ele,content,options){
          ...
          $(ele).html('<img src="'+qr_url_create(content)+'">');    
          return ;
    }
